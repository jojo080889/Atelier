...
(function() {
    ...
    LC.LiterallyCanvas = function() {
        ...
        LiterallyCanvas.prototype.repaint = function(dirty, drawBackground) {
            ...
            if (dirty) {
                ...
                if (this.oldPixelData != null) {
                    this.toGreyscale(this.bufferCtx);
                }
        ...
        LiterallyCanvas.prototype.draw = function(shapes, ctx, retryCallback) {
            ...
            drawShapes = function() {
                ...
                for (_i = 0, _len = shapes.length; _i < _len; _i++) {
                    shape = shapes[_i];
                    _results.push(shape.draw(ctx, retryCallback, _this));
                }
                return _results;
            };
        ...
        /* CUSTOM */
        LiterallyCanvas.prototype.toGreyscale = function(ctx) {
            ...
            for(var i = 0; i < h; i++) {
                for(var j = 0; j < w; j++) {
                    var index = (i * bytesPerPixel * w) + (j * bytesPerPixel);

                    var red = pixelData[index];
                    var green = pixelData[index + 1];
                    var blue = pixelData[index + 2];

                    var greyScale = (red * 0.3) + (green * 0.59) + (blue * .11);

                    pixelData[index] = greyScale;
                    pixelData[index + 1] = greyScale;
                    pixelData[index + 2] = greyScale;
                }
            }
    ...
    /* CUSTOM */
    LC.ConvertToGreyscaleAction = function() {
        function ConvertToGreyscaleAction(lc) {
            this.lc = lc;
        }
        ConvertToGreyscaleAction.prototype["do"] = function() {
            if (this.lc.oldPixelData == null) {
...
(function() {
    ...
    LC.ImageShape = function(_super) {
        ...
        ImageShape.prototype.draw = function(ctx, retryCallback, lc) {
            if (this.image.width) {
...
(function() {
    ...
    LC.Toolbar = function() {
        ...
        Toolbar.prototype.initButtons = function() {
            var _this = this;
            /* CUSTOM */
            this.$el.find(".greyscale-button").click(function(e) {
                return _this.lc.execute(new LC.ConvertToGreyscaleAction(_this.lc));
            });
